 ...
 */
@Generated
public class ReactiveMultipartAutoConfiguration__TestContext002_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<CodecCustomizer> getDefaultPartHttpMessageReaderCustomizerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<CodecCustomizer>forFactoryMethod(ReactiveMultipartAutoConfiguration.class, "defaultPartHttpMessageReaderCustomizer", ReactiveMultipartProperties.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webflux.autoconfigure.ReactiveMultipartAutoConfiguration", ReactiveMultipartAutoConfiguration.class).defaultPartHttpMessageReaderCustomizer(args.get(0)));
  }
  ...
  public static BeanDefinition getDefaultPartHttpMessageReaderCustomizerBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.webflux.autoconfigure.ReactiveMultipartAutoConfiguration");
