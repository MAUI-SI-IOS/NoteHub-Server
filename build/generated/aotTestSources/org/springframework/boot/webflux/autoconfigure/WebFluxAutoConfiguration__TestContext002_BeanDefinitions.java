 ...
 */
@Generated
public class WebFluxAutoConfiguration__TestContext002_BeanDefinitions {
  /**
  ...
  public static class EnableWebFluxConfiguration {
    /**
     * Get the bean instance supplier for 'org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$EnableWebFluxConfiguration'.
     */
    ...
    public static BeanDefinition getEnableWebFluxConfigurationBeanDefinition() {
      ...
      instanceSupplier = instanceSupplier.andThen(WebFluxAutoConfiguration_EnableWebFluxConfiguration__TestContext002_Autowiring::apply);
    ...
    private static BeanInstanceSupplier<FormattingConversionService> getWebFluxConversionServiceInstanceSupplier(
      ...
      return BeanInstanceSupplier.<FormattingConversionService>forFactoryMethod(WebFluxAutoConfiguration.EnableWebFluxConfiguration.class, "webFluxConversionService")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$EnableWebFluxConfiguration", WebFluxAutoConfiguration.EnableWebFluxConfiguration.class).webFluxConversionService());
    }
    ...
    public static BeanDefinition getWebFluxConversionServiceBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$EnableWebFluxConfiguration");
    ...
    private static BeanInstanceSupplier<Validator> getWebFluxValidatorInstanceSupplier() {
      return BeanInstanceSupplier.<Validator>forFactoryMethod(WebFluxAutoConfiguration.EnableWebFluxConfiguration.class, "webFluxValidator")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$EnableWebFluxConfiguration", WebFluxAutoConfiguration.EnableWebFluxConfiguration.class).webFluxValidator());
    }
    ...
    private static BeanInstanceSupplier<LocaleContextResolver> getLocaleContextResolverInstanceSupplier(
      ...
      return BeanInstanceSupplier.<LocaleContextResolver>forFactoryMethod(WebFluxAutoConfiguration.EnableWebFluxConfiguration.class, "localeContextResolver")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$EnableWebFluxConfiguration", WebFluxAutoConfiguration.EnableWebFluxConfiguration.class).localeContextResolver());
    }
    ...
    private static BeanInstanceSupplier<WebSessionManager> getWebSessionManagerInstanceSupplier() {
      return BeanInstanceSupplier.<WebSessionManager>forFactoryMethod(WebFluxAutoConfiguration.EnableWebFluxConfiguration.class, "webSessionManager", ObjectProvider.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$EnableWebFluxConfiguration", WebFluxAutoConfiguration.EnableWebFluxConfiguration.class).webSessionManager(args.get(0)));
    }
    ...
    private static BeanInstanceSupplier<RequestMappingHandlerMapping> getRequestMappingHandlerMappingInstanceSupplier(
      ...
      return BeanInstanceSupplier.<RequestMappingHandlerMapping>forFactoryMethod(WebFluxAutoConfiguration.EnableWebFluxConfiguration.class, "requestMappingHandlerMapping", RequestedContentTypeResolver.class, ApiVersionStrategy.class);
    }
    ...
    /**
     * Get the bean instance supplier for 'webFluxApiVersionStrategy'.
     */
    private static BeanInstanceSupplier<ApiVersionStrategy> getWebFluxApiVersionStrategyInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<ApiVersionStrategy>forFactoryMethod(WebFluxAutoConfiguration.EnableWebFluxConfiguration.class, "webFluxApiVersionStrategy")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$EnableWebFluxConfiguration", WebFluxAutoConfiguration.EnableWebFluxConfiguration.class).webFluxApiVersionStrategy());
    }

    /**
     * Get the bean definition for 'webFluxApiVersionStrategy'.
     */
    public static BeanDefinition getWebFluxApiVersionStrategyBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(ApiVersionStrategy.class);
      beanDefinition.setFactoryBeanName("org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$EnableWebFluxConfiguration");
      beanDefinition.setInstanceSupplier(getWebFluxApiVersionStrategyInstanceSupplier());
      return beanDefinition;
    }
    ...
    private static BeanInstanceSupplier<RouterFunctionMapping> getRouterFunctionMappingInstanceSupplier(
      ...
      return BeanInstanceSupplier.<RouterFunctionMapping>forFactoryMethod(WebFluxAutoConfiguration.EnableWebFluxConfiguration.class, "routerFunctionMapping", ServerCodecConfigurer.class, ApiVersionStrategy.class);
    }
  ...
  public static class WebFluxConfig {
    /**
     * Get the bean instance supplier for 'org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$WebFluxConfig'.
     */
    private static BeanInstanceSupplier<WebFluxAutoConfiguration.WebFluxConfig> getWebFluxConfigInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<WebFluxAutoConfiguration.WebFluxConfig>forConstructor(Environment.class, WebProperties.class, WebFluxProperties.class, ListableBeanFactory.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class)
              .withGenerator((registeredBean, args) -> new WebFluxAutoConfiguration.WebFluxConfig(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4), args.get(5), args.get(6), args.get(7), args.get(8), args.get(9), args.get(10)));
    }
  ...
  public static class WelcomePageConfiguration {
    ...
    private static BeanInstanceSupplier<RouterFunctionMapping> getWelcomePageRouterFunctionMappingInstanceSupplier(
      ...
      return BeanInstanceSupplier.<RouterFunctionMapping>forFactoryMethod(WebFluxAutoConfiguration.WelcomePageConfiguration.class, "welcomePageRouterFunctionMapping", ApplicationContext.class, WebFluxProperties.class, WebProperties.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$WelcomePageConfiguration", WebFluxAutoConfiguration.WelcomePageConfiguration.class).welcomePageRouterFunctionMapping(args.get(0), args.get(1), args.get(2)));
    }
    ...
    public static BeanDefinition getWelcomePageRouterFunctionMappingBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(RouterFunctionMapping.class);
      beanDefinition.setFactoryBeanName("org.springframework.boot.webflux.autoconfigure.WebFluxAutoConfiguration$WelcomePageConfiguration");
