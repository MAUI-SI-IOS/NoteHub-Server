 ...
 */
@Generated
public class HttpHandlerAutoConfiguration__TestContext002_BeanDefinitions {
  /**
  ...
  public static class AnnotationConfig {
    /**
     * Get the bean instance supplier for 'org.springframework.boot.webflux.autoconfigure.HttpHandlerAutoConfiguration$AnnotationConfig'.
     */
    ...
    private static BeanInstanceSupplier<HttpHandler> getHttpHandlerInstanceSupplier() {
      return BeanInstanceSupplier.<HttpHandler>forFactoryMethod(HttpHandlerAutoConfiguration.AnnotationConfig.class, "httpHandler", ObjectProvider.class, ObjectProvider.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.webflux.autoconfigure.HttpHandlerAutoConfiguration$AnnotationConfig", HttpHandlerAutoConfiguration.AnnotationConfig.class).httpHandler(args.get(0), args.get(1)));
    }
    ...
    public static BeanDefinition getHttpHandlerBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.webflux.autoconfigure.HttpHandlerAutoConfiguration$AnnotationConfig");
