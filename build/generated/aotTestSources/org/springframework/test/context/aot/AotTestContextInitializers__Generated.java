...
import com.mauisiios.notehub_server.integration.TestNoteRoutes__TestContext001_ApplicationContextInitializer;
...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.mauisiios.notehub_server.integration.TestNoteRoutes", () -> new TestNoteRoutes__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.mauisiios.notehub_server.integration.TestNoteRoutes", TestNoteRoutes__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
